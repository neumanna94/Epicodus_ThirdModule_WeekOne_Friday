export class Time {
  ...
  HumanAgeOnMercury(){
    ...
    return Time.NowToThenDifferenceSeconds()*(1/60)*(1/60)*(1/24)*(1/365.25)*(1/.24);
  }
  HumanAgeOnVenus(){
    //Second -> Minute -> Hour -> Day -> Year -> Conversion Factor for Planet.
    return Time.NowToThenDifferenceSeconds()*(1/60)*(1/60)*(1/24)*(1/365.25)*(1/.62);
  }
  HumanAgeOnMars(){
    //Second -> Minute -> Hour -> Day -> Year -> Conversion Factor for Planet.
    return Time.NowToThenDifferenceSeconds()*(1/60)*(1/60)*(1/24)*(1/365.25)*(1/1.88);
  }
  HumanAgeOnJupiter(){
    //Second -> Minute -> Hour -> Day -> Year -> Conversion Factor for Planet.
    return Time.NowToThenDifferenceSeconds()*(1/60)*(1/60)*(1/24)*(1/365.25)*(1/11.86);
  }
